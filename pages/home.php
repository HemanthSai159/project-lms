...
<body>
    ...
    <main>
        <div class="himg-div">
            ...
            <p class="himg-p2">eE</p>
            <img src="../background/womenreading.jpg" alt="home-hero image">
        </div>
        <div class="container-outermost">
            ...
            <div class="container-2">
                ...
                <div class="testimonial2">
                    <p>The courses in eLearn are from great companies and universities. The instructors are usually very good at making us understand the concept, and the materials in most courses are generally practical and essential. I'm a big fan
                        of eLearn.</p>
                    <div class="testinomial-img-name">
    ...
    <footer>
        <p class="p1"> Happy Learning with eLearn </p>
        <p class="p2"> Make a part of your journey with us. Enroll now ! </p>
        <hr>
        <p class="p3"><small>Copyright &copy; 2022 eLearn</small></p>
    </footer>
</body>
